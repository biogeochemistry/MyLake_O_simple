...
function [zz,Az,Vz,tt,Qst,Kzt,Tzt,Czt,Szt,Pzt,Chlzt,PPzt,DOPzt,DOCzt,DICzt,CO2zt,O2zt,NO3zt,NH4zt,SO4zt,HSzt,H2Szt,Fe2zt,Ca2zt,pHzt,CH4zt,Fe3zt,Al3zt,SiO4zt,SiO2zt,diatomzt,O2_sat_relt,O2_sat_abst,BODzt,Qzt_sed,lambdazt,Attn_zt,PARzt,PARMaxt,...
        ...
        CO2_ppmt,dO2Chlt,dO2BODt,dphotoDOCt,delC_org3,testi1t,testi2t,testi3t,...
         sediment_results] = ...
    solvemodel_v2_modified(M_start,M_stop,Initfile,Initsheet,Inputfile,Inputsheet,Parafile,Parasheet,varargin)
...
%       PARMaxt     : Predicted PAR irradiance (400-700nm) at surface (tt)(umol*m-2*s-1)
...
matsedlab_sediments_module = 0; %MATSEDLAB sediment module  %% NEW_DOCOMO
%fokema
photobleaching=0;               %photo bleaching: 0=TSA model, 1=FOKEMA model
flocculation_switch=0;                   % flocculation according to Wachenfeldt 2008  %% NEW_DOCOMO
% ==============
...
if (nargin>8) %if optional command line parameter input is used 
    ...
    [In_Z,In_Az,tt,In_Tz,In_Cz,In_Sz,In_TPz,In_DOPz,In_Chlz,In_DOCz,In_DICz,In_O2z,In_NO3z,In_NH4z,In_SO4z,In_HSz,In_H2Sz,In_Fe2z,In_Ca2z,In_pHz,In_CH4z,In_Fe3z,In_Al3z,In_SiO4z,In_SiO2z,In_diatomz,In_TPz_sed,In_Chlz_sed,In_FIM,Ice0,Wt,Inflw,...
        ...
        = modelinputs_v12_1b(M_start,M_stop,Initfile,Initsheet,Inputfile,Inputsheet,Parafile,Parasheet,dt);%change version(wasmodelinputs_v12) 5-10-2018 MC
 end
