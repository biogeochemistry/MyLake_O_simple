...
function [Tz,Cz,Sz,Pz,Chlz,PPz,DOPz,DOCz,DICz,O2z,NO3z,NH4z,SO4z,HSz,H2Sz,Fe2z,Ca2z,pHz,CH4z,Fe3z,Al3z,SiO4z,SiO2z,diatomz] = ...
    convection_v2(Tz_in,Cz_in,Sz_in,Pz_in,Chlz_in,PPz_in,DOPz_in,DOCz_in,DICz_in,O2z_in,NO3z_in,NH4z_in,SO4z_in,HSz_in,H2Sz_in,Fe2z_in,Ca2z_in,pHz_in,CH4z_in,Fe3z_in,Al3z_in,SiO4z_in,SiO2z_in,diatomz_in,Tprof_prev,Vz,Cw,f_par,lambdaz_wtot_avg,zz,swa_b0,tracer_switch,springautumn);
