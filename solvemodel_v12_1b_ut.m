...
theta_bod = Bio_par(26);        %Temperature adjustment coefficient for BOD, T ? 10 째C
theta_bod_ice = Bio_par(27);    %Temperature adjustment coefficient for BOD, T < 10 째C
theta_sod = Bio_par(28);        %Temperature adjustment coefficient for SOD, T ? 10 째C
theta_sod_ice = Bio_par(29);    %Temperature adjustment coefficient for SOD, T < 10 째C
BOD_temp_switch = Bio_par(30);             %Threshold for bod or bod_ice 캜
